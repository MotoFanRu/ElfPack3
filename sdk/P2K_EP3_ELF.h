...
#ifndef P2K_EP3_ELF_H
#define P2K_EP3_ELF_H
...
#define ELFMAG0                        (0x7F)              /* Magic number 0 byte. */
#define EI_MAG1                        (1)                 /* File identification byte 1 index. */
#define ELFMAG1                        ('E')     /* 0x45 *//* Magic number 1 byte. */
#define EI_MAG2                        (2)                 /* File identification byte 2 index. */
#define ELFMAG2                        ('L')     /* 0x4C *//* Magic number 2 byte. */
#define EI_MAG3                        (3)                 /* File identification byte 3 index. */
#define ELFMAG3                        ('F')     /* 0x46 *//* Magic number 3 byte. */
...
/* Machine field. */
#define EM_RCE                         (39)      /* 0x27 *//* Motorola RCE (RISC Engine, M-CORE). */
#define EM_ARM                         (40)      /* 0x28 *//* ARM. */
#define EM_CSKY                        (252)     /* 0xFC *//* C-SKY (alternative Motorola RCE, M-CORE). */
