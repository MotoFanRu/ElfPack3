#ifndef P2K_CRC32_PORTABLE_H
#define P2K_CRC32_PORTABLE_H
...
static const UINT32 P2K_CRC32_TABLE[256] = {
...
static inline UINT32 P2K_CRC32(const char *src) {
	UINT32 crc = 0xFFFFFFFF;
	while (*src) {
		crc = P2K_CRC32_TABLE[(crc ^ *src++) & 0xFF] ^ (crc >> 8);
	}
	return ~crc;
}
